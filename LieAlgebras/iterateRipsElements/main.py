...
def solve_system_z3():
    ...
    file_output_names = ['k1', 'k2', 'k3', 'a11', 'a12', 'a13', 'a21', 'a22', 'a23', 'a31', 'a32', 'a33', 'b12', 'b13', 'b23']
    ...
    while True:
        ...
        # 6. NEW Exclude condition 3: k differences must be greater than 1
        skip_k_diff = z3.Or(k2 - k1 <= 1, k3 - k2 <= 1)
        solver.add(z3.Not(skip_k_diff))
        ...
        while solver.check() == z3.sat:
            ...
            b13_val = (2 ** (solution['k3'] - solution['k2'])) * solution['t']
            file_solution = dict(solution)
            file_solution['b13'] = b13_val
            parts = [f"{name} = {file_solution[name]}" for name in file_output_names]
